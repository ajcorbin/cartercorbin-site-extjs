...
folder are mapped to the application's root namespace, 'CarterCorbinextjs'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CarterCorbinextjs"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CarterCorbinextjs' in the same way
as `"CarterCorbinextjs/sass/src"`.
